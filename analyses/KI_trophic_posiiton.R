...
### Carnivorous fish source amino acid d15N patterns (Extended Data Fig. 4) -----------------------------------------------------------
Phe <- ggplot(fish.N, aes(sci_name, Phe, fill = dist_cat)) + 
  geom_boxplot(outlier.shape = 1, alpha = 0.75) +
  geom_point(position = position_dodge(0.75), pch=1, size=2)+
  theme_test() +
...
# > Plot standard length vs. TPcsia (Supplementary Fig. 3) -----------------------------------------------------------
...
# > Plot standard lenggth vs. TPcsia by species (Extended Data Fig. 5) -----------------------------------------------------------
...
# > Plot UNCORRECTED trophic position by species and dist_cat (Supplementary Fig. 4) -----------------------------------------------------------
...
# > Correct TPcsia to mean standard length for each species (Supplementary Table 5) -----------------------------------------------------------
...
mean(diff1,diff2,diff3,diff4,diff5,diff6)



# > Plot CORRECTED  trophic position by species and dist_cat (Fig. 5) -----------------------------------------------------------
...
# > Kruskal-Wallis test comparing TPcsia by species and dist_cat (Extended Data Table 4) -----------------------------------------------------------
...
# > General linear modesls comparing CORRECTED TP by species and dist_cat (Table 1) -----------------------------------------------------------

# Compare models with continuous vs. discrete dist_cat data
# Results of models with continuous dist_cat data reported in Table 1
...
# >> Continuous data (Supplementary Table 7) -----------------------------------------------------------
...
# >> Categorical data (Supplementary Table 8) -----------------------------------------------------------
